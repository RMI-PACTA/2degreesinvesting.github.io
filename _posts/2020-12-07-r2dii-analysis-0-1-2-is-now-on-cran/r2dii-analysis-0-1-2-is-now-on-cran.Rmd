...
r2dii.analysis 0.1.2 is now on CRAN. This release fixes a number of bugs. All changes are listed [here](https://2degreesinvesting.github.io/r2dii.analysis/news/index.html); this post highlights the major bugs fixes.
...
To use r2dii.analysis, you can load it into your active R session with `library()`. This example uses some other packages that you may also load now.
...
Let's also calculate some demo data frames, that we can use to help explain the bugfixes:
