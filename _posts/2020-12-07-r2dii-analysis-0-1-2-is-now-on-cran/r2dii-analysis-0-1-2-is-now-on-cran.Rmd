...
The only user-facing change to r2dii.match was the addition of the `...` argument which allows further arguments to be passed directly the the `stringdist::stringsim()` function. For most users, the default values are likely still sufficient: 
...
Pull up the documentation of either `stringdist::stringsim` for more details. 
