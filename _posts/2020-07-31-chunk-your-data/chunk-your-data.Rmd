...
The `matched` result should be similar to that of `match_name(loanbook, ald)`. Your next steps are documented on the website of [r2dii.match](https://2degreesinvesting.github.io/r2dii.match/index.html).
